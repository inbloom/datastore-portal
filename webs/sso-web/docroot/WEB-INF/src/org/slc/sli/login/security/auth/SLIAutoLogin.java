...
/**
 * SLIAutoLogin.java Purpose: Login to Liferay portal automatically, creates
...
public class SLIAutoLogin implements AutoLogin {
		...
		try {
			...
			try {
				...
				user = UserLocalServiceUtil.getUserByScreenName(companyId,
						SLISSOUtil.convertScreenName(userData.getUser_id()));
	...
	private static Log _log = LogFactoryUtil.getLog(SLIAutoLogin.class);
