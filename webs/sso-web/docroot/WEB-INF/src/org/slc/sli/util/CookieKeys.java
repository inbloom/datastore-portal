...
public class CookieKeys implements com.liferay.portal.kernel.util.CookieKeys {
	...
	public static void addCookie(
		...
		if (!GetterUtil
				.getBoolean(PropsUtil
						.get(PropsKeys.SESSION_ENABLE_PERSISTENT_COOKIES)) ||
						GetterUtil.getBoolean(PropsUtil
								.get(PropsKeys.TCK_URL))) {
	...
	public static String getDomain(HttpServletRequest request) {
		...
		if (Validator.isNotNull(PropsUtil
				.get(PropsKeys.SESSION_COOKIE_DOMAIN))) {
			return PropsUtil
			.get(PropsKeys.SESSION_COOKIE_DOMAIN);
		}
	...
	public static void validateSupportCookie(HttpServletRequest request)
		...
		if (GetterUtil
				.getBoolean(PropsUtil
						...
						GetterUtil
						.getBoolean(PropsUtil
								.get(PropsKeys.SESSION_TEST_COOKIE_SUPPORT))) {
