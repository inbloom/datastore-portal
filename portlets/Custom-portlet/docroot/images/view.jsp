...
<aui:form id="formFile" action="<%= saveDataURL %>" method="post" onsubmit="return <portlet:namespace />extractCodeFromEditor()" name="fm"  enctype="multipart/form-data">
	...
	<liferay-ui:error key="sli_edOrgName" message="Your email id is not correct formate" />
	  ...
	  <span class="aui-field aui-field-text">
            <span class="aui-field-content">
                ...
                <span class="aui-field-element ">
					<aui:input name="sli_edOrgName" type="text" style="width:210px;" onclick="if(this.value=='SLC...'){this.value=''}" onblur="if(this.value==''){this.value='SLC'}" label=" " showRequiredLabel="<%=false %>"  value="">
			...
			<span class="aui-field-content">
				...
				<span class="">
					  ...
					  <input type="button" id="browseButton" value="Choose File" onclick="selecteFile.click()">
					   ...
					   <a href="/Custom-portlet/images/default.png">download file</a>
				 </span>
		</span>
...
var form = A.one('#<portlet:namespace />fm');
	if (form) {
			...
			'submit',function extractCodeFromEditor() {			 
				  ...
				  var b = document.<portlet:namespace />fm.sli_edOrgName.value;				  
				  if(b==null || b==""){
				  return false;}
				},function submitForm(){					 
