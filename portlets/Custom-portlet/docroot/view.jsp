...
<portlet:actionURL var="saveDataURL" name="saveData">
	<portlet:param name="viewJSP" value="/success.jsp" />	 
</portlet:actionURL>

<aui:form id="formFile" action="<%= saveDataURL %>" method="post" onsubmit="return <portlet:namespace />extractCodeFromEditor()" name="fm"  enctype="multipart/form-data">
	 ...
	 <span class="aui-field aui-field-text">
			<span class="aui-field-content">
				...
				<span class="">
					  ...
					  <input id="selectedFile" type="file" onpropertychange="add()" style="position:absolute;visibility:hidden;" name="<portlet:namespace />Image_Name" onchange="readURL(this);">
	  ...
	  <span class="aui-field aui-field-text">
            <span class="aui-field-content">
                ...
                <span class="aui-field-element ">
					<input name="sli_edOrgName" type="text" style="width:210px;" onclick="if(this.value=='SLC...'){this.value=''}" onblur="if(this.value==''){this.value='SLC'}"   value=""/>
					<liferay-ui:error key="sli_edOrgName" message="Please enter Educational Organization Name" />
					<liferay-ui:error key="sli_edOrgNameLenght" message="Please enter Educational Organization Name between 3 to 12 characters" />
				</span>
            </span>
        </span>
		<span class="aui-field aui-field-text">
            <span class="aui-field-content">
                ...
                <span class="aui-field-element ">
					...
					<div id ="defaultEditorLic" style="display: block;">						
						<textarea id="licAgree" name="licAgree" cols="12" rows="10"> </textarea>
					</div>
                    <a onclick="add('licAgree')">restore to default</a>
					<liferay-ui:error key="edOrgNameEditorLength" message="Please enter License Agreement between 20 to 1000 characters" />					
                </span>
            </span>
        </span>
		<span class="aui-field aui-field-text">
			...
			<span class="aui-field-content">
				...
				<span class="aui-field-element ">
					<div id="sli_richEditor">
							...
							<liferay-ui:error key="adminmessageEditorLength" message="Please enter Admin Page Welcome  between 20 to 1000 characters" />
					 </div>
				</span>
			</span>
		</span>
			...
			<span class="aui-field-content">
				...
				<span class="aui-field-element ">
					<div id="sli_richEditor">
						...
						<liferay-ui:error key="footermessageEditorLength" message="Please enter Footer between 10 to 50 characters" />
					</div>
				</span>
			</span>
		</span>
		<span class="aui-field aui-field-text">
			<span class="aui-field-content">
				...
				<span class="">
					  <label id="uploaded_file" style="font-size:16px;margin-right:10px;"></label>
...
function uploaded_file(input)
{
	var file_name = '';
	file_name = document.getElementById('selecteFile').value;
	document.getElementById('uploaded_file').innerHTML = file_name;
