...
public class RESTClient {
     ...
     */
    public JsonObject getEmailAddress(String token) {
	 ...
	 * @param token
	 *            not used yet
	 * @return a {@link JsonElement} if the request is successful and returns
	...
	public String makeJsonRequestWHeaders(String path, String token,
		...
		if (token != null) {
			...
			try {
				response = template.exchange(url.toString(), HttpMethod.GET,
						entity, String.class);
			} catch (HttpClientErrorException e) {
				logger.debug("Catch HttpClientException: "
