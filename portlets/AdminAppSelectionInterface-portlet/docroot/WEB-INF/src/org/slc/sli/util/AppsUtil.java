		...
		for (JsonElement jsonEle : jsonArray) {
			...
			if(!applicationUrl.equalsIgnoreCase("\"\"")){
				...
				for(JsonElement innerJsonEle : endPoints){
					...
					String innerAppName = innerJsonEle.getAsJsonObject().get("name").toString().replaceAll("\"\"","");
					String innerAppDescription = innerJsonEle.getAsJsonObject().get("description").toString().replaceAll("\"\"","");
					String innerAppUrl = innerJsonEle.getAsJsonObject().get("url").toString().replaceAll("\"\"","");
