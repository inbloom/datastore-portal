...
<br /><br /><br /><br /><br /><br />
    ...
    <footer id="sli_footer">
	  ...
	  <!-- US 2854- display footer text as per environment -->
        <%if(is_sandbox){ %>
        <p>Copyright &copy; 2012 Shared Learning Collaborative, LLC (SLC) <a target="_blank" href="http://www.inbloom.org/privacy-policy">Privacy Policy</a>  <a target="_blank"  href="http://www.inbloom.org/terms-of-use">Terms of Use</a> </p>
      <%}else{ %>
      <p>Copyright &copy; 2012 Shared Learning Collaborative, LLC (SLC)  <a target="_blank" href="http://www.inbloom.org/privacy-policy">Privacy Policy</a> <a target="_blank" href="http://www.inbloom.org/terms-of-use">Terms of Use</a></p>
      <%} %>
      </div>
