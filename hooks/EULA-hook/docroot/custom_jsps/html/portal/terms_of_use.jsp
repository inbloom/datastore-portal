...
<%is_sandbox = GetterUtil.getBoolean(PropsUtil.get("is_sandbox")); 
			...
			if(is_sandbox){%>
			You are in the inBloom developer sandbox environment which is subject to the <a target="_blank"  href="http://dev.slcedu.org/legal/terms-of-use">Terms of Use</a> and <a target="_blank" href="http://dev.slcedu.org/legal/privacy">Privacy Policy</a> of the inBloom developer website. <br/><br/>
...
Please note:  No personally identifiable information under the Family Educational Rights and Privacy Act, 20 U.S.C. &sect;1232 g, and its regulations ("<b>FERPA</b>") or other personal information may be accessed, uploaded or otherwise provided to the developer sandbox environment.
			...
			<%}else{%>
			<p><strong>Terms of Use for Access to inBloom Portal Site</strong></p>
			<p>Effective Date: December 12, 2012</p>
			<br>
			<p><strong>Introduction</strong></p>
			<p>Welcome to the inBloom Portal Site and Service.</p>
			<p>This site located at [portal.slcedu.org and other hostnames within the slcedu.org domain] (the "<strong>Site</strong>") is provided by the inBloom, LLC (the "<strong>inBloom</strong>", "<strong>we</strong>", "<strong>us</strong>", etc.). The inBloom, LLC is a limited liability company existing under the laws of the State of Washington, U.S.A. The inBloom is a not-for-profit entity organized and operated to carry out the charitable and educational purposes of its members within the meaning of Section 501(c)(3) of the Internal Revenue Code of 1986.</p>
			<p>These Terms of Use for Access to the inBloom Portal Site ("<strong>Terms</strong>"), including the <a target="_blank" href="http://dev.slcedu.org/legal/portal-privacy-policy">Portal Privacy Statement</a>, are an agreement between the inBloom and you and govern your use of the Site.</p>
			<p><strong><u>Note to State and District Employees and Their Contractors:</u></strong>  In the event that any of the provisions in these Terms conflict with any terms relating to your obligations as an Authorized User under the inBloom Service Agreement entered into between the inBloom and a School District or State Educational Agency that employs you or that you are serving as a contractor, such inBloom Service Agreement will control.</p>
			<br>
			<ol style="list-style-type:decimal;">
				<li>
					<p><strong>Eligibility.</strong></p>
					<p>This Site is provided as part of the inBloom software system ("<strong>inBloom Service</strong>") and is only accessible to users who have been authorized by a School District or State Educational Agency to access this Site ("<strong>you</strong>" or "<strong>Authorized User</strong>").</p>
				...
				<li>
					...
					<p><strong>inBloom Service</strong> means a web-based software system, provided as a service, which is designed to allow personalized learning for students and to improve student achievement by providing  curriculum content, assessments and professional development and to facilitate evaluation and compliance of state- and federal-supported education programs.</p>
					<p><strong>Third Party Application</strong> means a software application, provided by a Third Party Application Provider, that is designed to be used through the inBloom Service.</p>
					<p><strong>Third Party Application Providers</strong> means (1) third party program application providers who have been granted access to the inBloom Service and Customer Data in order to  make their software applications available through the Site, through separate agreements with a School District and/or SEA, and (2) authorized representatives of State Educational Agencies that assist the State Educational Agency in evaluation or compliance-related activities regarding state- or federal-supported education programs.</p>
				</li>

				<li>
					<p><strong>Registration and Creating Profiles etc.; Attribution of Electronic Acts to You</strong></p>
					<p>To access the Site and use the inBloom Service, you may be assigned an account by a Customer's administrator, or you may have to complete a registration process to create an account - approved by a Customer's administrator -- including user name and password that identifies you as an Authorized User ("<strong>User ID</strong>"). You agree to guard your User ID as confidential information-if you are careless with it, others may be able to access you're and/or such Customer's information. Access to portions and functionality of the Site may be limited based on role-based permissions linked to your User ID that are granted by a School District and/or State Educational Agency.  If you are using an account assigned to you by an administrator, different or additional terms may apply and your administrator may be able to access or disable your account.</p>
					<p>You agree that all uses of the User ID established for you during the registration  process will be attributed to and legally bind you and may be relied upon by the inBloom and our agents, affiliates, and other third parties with whom we work in order to provide the Site and inBloom Service (including but not limited to our and their respective affiliates, officers, employees and agents) (collectively "<strong>inBloom Third Parties</strong>"), as being a use made by you, even if someone else used your User ID.</p>
				...
				<li>
					...
					<ul>
						...
						<li>do anything that is illegal, infringing, fraudulent, malicious or could expose inBloom or users of the Site to harm or liability; or</li>
				...
				<li>
					...
					<p>The Site contains a variety of content, including (without limitation) information, data, Customer Data, text, software applications,  graphics, video, messages or other materials that are available for access and use via the Site.  Except as stated in these Terms, you may review and use such content solely for educational or service purposes authorized in the applicable inBloom Service Agreement between the inBloom and a School District or State Educational Agency participating in the inBloom - and consistent with your responsibilities to such School District or State Educational Agency.  YOU MAY NOT SELL THE SITE CONTENT OR OTHERWISE DISTRIBUTE IT FOR A FEE. YOU WILL NOT USE OR PROVIDE ACCESS TO THE SITE OR ITS CONTENT TO ANY THIRD PARTIES EXCEPT AS EXPRESSLY PERMITTED BY THESE TERMS. </p>
					<ol style="list-style-type:upper-alpha;">
						<li>
							<p><strong>Use of Personally Identifiable Information</strong></p>
							<p>Your use of Customer Data consisting of Personally Identifiable Information is limited to the purposes described in the inBloom Service Agreement or your agreement with your respective School District or SEA, and you agree that the use of any Customer Data you have access to will be in accordance with such agreements, as well as applicable federal and state law, including FERPA.  Third Party Application Providers are also subject to the additional terms set forth in Section 6.</p>
						</li>
						<li>
							<p><strong>inBloom Applications</strong></p>
							<p>Any content consisting of inBloom software applications (including those forming part of the inBloom Service) accessible to you on the Site are made available for your use subject to these Terms.  The inBloom gives you a non-assignable and non-exclusive license to use the inBloom software applications provided to you as part of the inBloom Service for the purpose of a Customer’s educational purposes and in its operations.</p>
							<p>We note that software applications used in the inBloom Service may be offered under an open source license that we will make available to you.  There may be some provisions in the open source license that expressly override these Terms. Except where permitted under an open source license or separate agreement, you may not copy, modify, distribute sell or lease any part of the inBloom Service, including the inBloom software applications, nor may you reverse engineer or attempt to extract the source code of that software, unless applicable law prohibits these restrictions.</p>
						</li>
						<li>
							<p><strong>Use of Third Party Applications</strong></p>
							<p>You may also be able to access and use inBloom-compatible Third Party Applications developed by Third Party Application Providers and approved for use by each Customer for its Authorized Users. Each Third Party Application Provider is solely responsible for all of the content of its Third Party Applications.</p>
				...
				<li>
					...
					<ul>
						...
						<li>You will give the inBloom all rights necessary to enable your Third Party Application to work with the inBloom Service.</li>
						...
						<li>You will notify the inBloom of any known or suspected unauthorized access to Personally Identifiable Information or confirmed breach of such Third Party Application Provider's security measures.</li>
					</ul>
				</li>
				<li>
					<p><strong>Intellectual Property Rights</strong></p>
					<p>This Site is protected by intellectual property laws and you agree to respect them. Unless otherwise specified, the inBloom and its licensors retain full copyright ownership, rights and protection in all content and material it provides on the Site. Except as otherwise expressly provided in these Terms, you may not copy, distribute, transmit, display, perform, reproduce, publish, license, rewrite, create derivative works from, transfer or sell any material contained on the Site without the prior consent of the inBloom or the copyright owner.  The inBloom does not condone the infringement of intellectual property rights on our Site. </p>
				</li>
				<li>
					<p><strong>Feedback; Your License to Us</strong></p>
					<p>We hope that you will provide your Feedback (as defined below) so that we may better support, improve and pursue our educational purposes. However, you agree that you will not supply Feedback that infringes or violates the rights of others, and you hereby grant a License to the inBloom (as defined below) in your Feedback. You agree that we have no obligation to pay you or anyone else for Feedback or for the License to the inBloom. "<strong>Feedback</strong>" means all remarks, data, suggestions, methods, surveys, reports, processes and ideas (including patentable ideas) and other content that you provide by using the Site or provide about it, or any aspect of our operations, whether provided to us or persons working with us or the Feedback, and whether provided through the Site or through another forum or media such as a chat room, survey, report, software tool, bulletin board or otherwise.</p>
					<p>As used above, "License to the inBloom" means a non-exclusive, perpetual, irrevocable, royalty-free, transferable, sub-licensable, worldwide license to the inBloom to exercise all now or later existing intellectual property rights or other rights of yours or others in the Feedback, for purposes of supporting the inBloom's educational purposes (as determined by us in our discretion from time to time) in full or in part and in all possible media (now known or later developed). The foregoing rights include (but are not limited to), the right to display, perform, read (on air or otherwise), and publish in public or private sites, newspapers or other media, brochures, reports and so on, all or part of the Feedback and any other information that you provide through or relating to our Site or the Content. The License to the inBloom is in addition to any (if any) that you may be required to provide under any separate agreement between us and you (including grants or other agreements).</p>
				</li>
				<li>
					<p><strong>Indemnification</strong></p>
					<p>You agree to defend, indemnify and hold harmless the inBloom, its contractors and its licensors, and their respective directors, officers, employees and agents from and against any and all third party claims and expenses, including attorneys' fees, arising out of your use of the Site or Content, including but not limited to out of your violation of any representation, warranty, obligation or agreement contained in these Terms. </p>
				</li>
				<li>
					<p><strong>NO WARRANTIES, CONDITIONS OR OTHER DUTIES</strong></p>
					<p>The Site and all Content (regardless of who generates it), Site functionality, assistance and services provided by the Site, the inBloom or any inBloom Third Parties (collectively, "Complete Site") are subject to change and are provided by us or any inBloom Third Parties "AS IS" and "AS AVAILABLE, without any assurance, warranty and conditions, and without the undertaking of any duty, of any kind either express or implied, including but not limited to, any (if any) warranties or conditions of merchantability and fitness for a particular purpose, any duty (if any) of workmanlike effort or lack of negligence and any representation that this technology will fit your needs.</p>
				...
				<li>
					...
					<p>These Terms, including the Portal Privacy Statement (including any of the supplemental privacy policies), Amendments and any:  (a) notices, terms and items incorporated into any of them; (b) additional terms and conditions contained on the Site for particular activities or Content; and (c) our disclosures and your consents provided on or in connection with the Site or any Content, service or other activity; constitute the entire agreement between you and the inBloom regarding the Complete Site or the subject matter of the foregoing (collectively, "Entire Agreement").  If any provision of the Entire Agreement is found by a court of competent jurisdiction to be invalid, its remaining provisions will remain in full force and effect, provided that the allocation of risks described herein is given effect to the fullest extent possible.  The foregoing does not impair the enforceability of additional agreements you enter into with the inBloom including, without limitation, the inBloom Service Agreement and inBloom Data and Information Security Policy.</p>
					...
					<p>The inBloom retains the right to assign its rights, privileges, responsibilities, and obligations, as identified in these Terms or in other documents, to a third party, in whole or in part, for administration, technical support, marketing, or any other purpose at any time without providing notice to you or other users through the Site or by any other means.</p>
				</li>
				<li>
					<p><strong>Electronic Transactions</strong></p>
					<p>We, our employees, agents, affiliates, assigns and each of the inBloom Third Parties may deal with you electronically now and in the future in their respective discretion during the entire course of activities pursued with you (e.g., applying for, obtaining, implementing, terminating and enforcing a grant or anything else), including but not limited to having you electronically sign documents and receive electronic notices.  We and each of the inBloom Third Parties also reserve the right to deal non-electronically and to require you to do so.</p>
				</li>
				<li>
					...
					<p>The inBloom will not give, sell, or otherwise transfer addresses maintained by it to any other party for the purposes of initiating, or enabling others to initiate, electronic mail messages except as authorized by law or appropriate inBloom personnel or policies. Except for parties authorized to have such addresses, persons may violate federal law if they: (1) initiate the transmission to our computers or devices of a commercial electronic mail message (as defined in the U.S. "CAN-SPAM Act of 2003") that does not meet the message transmission requirements of that act; or (2) assist in the origination of such messages through the provision or selection of addresses to which the messages will be transmitted.</p>
					<p><strong>Notice Regarding Trademarks.</strong></p>
					<p>All trademarks, service marks, and trade names used in the Site (including without limitation: the inBloom, the inBloom and the associated designs and logos) (collectively "Marks") are owned by (1) the inBloom or (2) their respective trademark owners, and are either trademarks or registered trademarks of the inBloom, its affiliates, partners or licensors. You may not use, copy, reproduce, republish, upload, post, transmit, distribute, or modify the Marks in any way, including in advertising or publicity pertaining to distribution of materials on this Site, without the inBloom's prior written consent. The use of the Marks on any other website or networked computer environment is not allowed. You may not use the Marks as a "hot" link on or to any other website unless establishment of such a link is approved in advance.</p>
					<p><strong>Notice Regarding Copyright ownership: </strong></p>
					<p>Copyright 2012 inBloom, LLC and/or its affiliates and suppliers. All rights reserved. </p>
					<p><strong>Notice Regarding Copyright Agent</strong></p>
					<p>The inBloom respects the intellectual property rights of others and requests that Site users do the same. Anyone who believes that their work has been infringed under copyright law may provide a notice to the designated Copyright Agent for the Site containing the following:</p>
					<ul>
						...
						<li>Identification of the material that is claimed to be infringing and information reasonably sufficient to permit the inBloom to locate the material; </li>
					...
					<p><strong>Security:</strong> You agree to adhere to commercially reasonable security practices relevant to your interaction with the inBloom Service. You agree to use commercially reasonable efforts to notify the inBloom in writing no more than twenty-four (24) hours after your detection of a security breach or privacy violations related to data provided through the inBloom Service. </p>
				</li>
			</ol>
			</br>
			</br>
...
<br /><br /><br /><br /><br /><br />
    ...
    <footer id="sli_footer">
	  ...
	  <!-- US 2854- display footer text as per environment -->
        <%if(is_sandbox){ %>
        <p>(C) inBloom, LLC. <a target="_blank" href="http://dev.slcedu.org/legal/privacy">Privacy Policy</a>  <a target="_blank"  href="http://dev.slcedu.org/legal/terms-of-use">Terms of Use</a> </p>
      <%}else{ %>
      <p>&copy; inBloom, LLC. <a target="_blank" href="http://dev.slcedu.org/legal/portal-privacy-policy">Privacy Policy</a> <a target="_blank" href="http://dev.slcedu.org/legal/portal-terms-use">Terms of Use</a></p>
      <%} %>
      </div>
    </footer>
